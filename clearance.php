...
<style>
  ...
  <body>
    ...
    <center><div style="background-color:#F9E79F">
      <center><h2 style="font-size:30px;color:Black">Clearance</h2></center>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <h1 class="mb-5" style="font-size:40px">"END OF REASON SALE IS ON "</h1>
          </div>
...
<div style="background-color:#AED6F1">
     <center>
      ...
      $order59 ="SELECT * FROM clearance where SID=$CustID";
      $food9 = mysqli_query($conn, $order59);
      while($oss55 = mysqli_fetch_assoc($food9))
      {echo '<tr><td>'. $oss55["TRY"].'</td><td>'. $oss55["SICRY"] .'</td><td>'. $oss55["QUANT"].'</td><td>'. $oss55["ACTUALPRICE"].'</td><td>'. $oss55["DISCOUNTEDPRICE"].  '</td><td>';
      }
?>
      </table>
      <br>
